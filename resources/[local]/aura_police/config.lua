...
Config.Stations = {
    ['mission_row'] = {
        ...
        armory = {
            coords = vec3(481.65, -995.32, 30.69),
            stashId = 'police_armory_mrpd',
            slots = 50,
            maxWeight = 500000 -- 500kg
        },
        evidence = {
            coords = vec3(474.93, -996.38, 26.27),
...
-- ============================================================================
-- 3. DOTACIÓN DE ARMERÍA POR RANGO POLICIAL
-- ============================================================================
Config.ArmoryWeapons = {
    [0] = { -- Cadete
        { name = 'weapon_taser', label = 'Pistola Taser X26', count = 1 },
        { name = 'weapon_nightstick', label = 'Porra Reglamentaria', count = 1 },
        { name = 'weapon_flashlight', label = 'Linterna Táctica', count = 1 },
        { name = 'armor', label = 'Chaleco Ligero', count = 2 }
    },
    [1] = { -- Oficial I
        { name = 'weapon_combatpistol', label = 'Pistola Glock 19 (9mm)', count = 1 },
        { name = 'ammo-9', label = 'Munición 9mm (x50)', count = 2 },
        { name = 'weapon_taser', label = 'Pistola Taser X26', count = 1 },
        { name = 'weapon_nightstick', label = 'Porra Reglamentaria', count = 1 },
        { name = 'armor', label = 'Chaleco Balístico', count = 3 }
    },
    [2] = { -- Oficial II
        { name = 'weapon_combatpistol', label = 'Pistola Glock 19 (9mm)', count = 1 },
        { name = 'ammo-9', label = 'Munición 9mm (x50)', count = 3 },
        { name = 'weapon_pumpshotgun', label = 'Escopeta Mossberg 590', count = 1 },
        { name = 'ammo-shotgun', label = 'Cartuchos Escopeta (x20)', count = 2 },
        { name = 'weapon_taser', label = 'Pistola Taser X26', count = 1 },
        { name = 'armor', label = 'Chaleco Reforzado', count = 3 }
    },
    [3] = { -- Sargento o superior (Acceso a Carabina M4)
        { name = 'weapon_combatpistol', label = 'Pistola Glock 19 (9mm)', count = 1 },
        { name = 'ammo-9', label = 'Munición 9mm (x50)', count = 3 },
        { name = 'weapon_carbinerifle', label = 'Carabina Táctica M4', count = 1 },
        { name = 'ammo-rifle', label = 'Munición Rifle 5.56 (x60)', count = 3 },
        { name = 'weapon_pumpshotgun', label = 'Escopeta Mossberg 590', count = 1 },
        { name = 'ammo-shotgun', label = 'Cartuchos Escopeta (x20)', count = 2 },
        { name = 'weapon_taser', label = 'Pistola Taser X26', count = 1 },
        { name = 'armor', label = 'Chaleco Táctico Pesado', count = 4 }
    }
}
