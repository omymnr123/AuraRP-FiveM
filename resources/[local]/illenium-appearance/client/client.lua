...
function InitializeCharacter(gender, onSubmit, onCancel)
    local genderKey = "Male"
    if gender == 1 or gender == "1" or gender == "female" or gender == "Female" or gender == "f" or gender == "F" then
        genderKey = "Female"
    end
    if Config.InitialPlayerClothes and Config.InitialPlayerClothes[genderKey] then
        SetInitialClothes(Config.InitialPlayerClothes[genderKey])
    end
...
exports("InitializeCharacter", InitializeCharacter)
